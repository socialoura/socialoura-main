...
import TiktokProfileSearchInput from '@/components/tiktok-upsell-v2/ProfileSearchInput';
...
import TiktokCheckoutSummary from '@/components/tiktok-upsell-v2/CheckoutSummary';
...
export default function TiktokUpsellPage() {
  ...
  useEffect(() => {
    posthog.capture('tiktok2_tunnel_page_viewed', { target_platform: 'tiktok', source: 'tiktok-2_funnel' });
  }, []);
