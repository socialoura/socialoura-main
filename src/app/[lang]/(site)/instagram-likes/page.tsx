      ...
      <section className="relative overflow-hidden min-h-[70vh] flex items-center">
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-20 lg:px-8 w-full">
          <div className="text-center">
            {/* Heart Badge */}
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-red-500 to-pink-600 mb-8 shadow-lg shadow-red-500/30">
            ...
            <h1 className="text-4xl font-black tracking-tight sm:text-5xl md:text-6xl mb-8 leading-tight bg-gradient-to-r from-red-400 via-pink-400 to-red-400 bg-clip-text text-transparent">
              {t.hero.highlight}
            </h1>
