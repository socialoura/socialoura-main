      ...
      <section className="relative overflow-hidden min-h-[70vh] flex items-center">
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-20 lg:px-8 w-full">
          <div className="text-center">
            {/* Platform Badge */}
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-black mb-8 shadow-lg shadow-gray-500/30 border border-gray-700">
            ...
            <h1 className="text-4xl font-black tracking-tight sm:text-5xl md:text-6xl mb-8 leading-tight bg-gradient-to-r from-gray-300 via-white to-gray-300 bg-clip-text text-transparent">
              {t.hero.platform}
            </h1>
