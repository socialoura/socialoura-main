          ...
          return (
            ...
            >
              ...
              {service.type === 'followers' && (
                <div className="absolute top-3 right-3 z-20 border border-pink-500/50 text-pink-400 bg-transparent text-[10px] sm:text-xs font-bold uppercase tracking-wider px-2 py-0.5 rounded-full flex items-center gap-1">
