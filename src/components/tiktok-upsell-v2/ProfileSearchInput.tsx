...
import { Loader2, Search, AlertCircle, ChevronRight, Users } from 'lucide-react';
...
export default function TiktokProfileSearchInput({ lang }: ProfileSearchInputProps) {
  ...
  const handleSearch = async (searchUsername: string) => {
    ...
    posthog.capture('tiktok2_step1_search_initiated', { target_platform: 'tiktok', source: 'tiktok-2_funnel' });
    ...
    try {
      ...
      posthog.capture('tiktok2_step1_search_failed', { error_reason: errorMsg, target_platform: 'tiktok', source: 'tiktok-2_funnel' });
  ...
  const handleSelectProfile = () => {
    ...
    posthog.capture('tiktok2_step1_profile_found', { follower_count: searchResult.followersCount, target_platform: 'tiktok', source: 'tiktok-2_funnel' });
